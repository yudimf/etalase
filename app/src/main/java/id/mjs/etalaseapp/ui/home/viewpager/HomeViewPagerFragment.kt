package id.mjs.etalaseapp.ui.home.viewpager
...
import id.mjs.etalaseapp.adapter.HomePagerAdapter
...
class HomeViewPagerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val root =  inflater.inflate(R.layout.fragment_home_view_pager, container, false)

        searchBar = root.findViewById(R.id.searchBarHomeViewPager)
        setSearchBar()

        viewPager = root.findViewById(R.id.home_view_pager)
        tabs = root.findViewById(R.id.home_tab)
