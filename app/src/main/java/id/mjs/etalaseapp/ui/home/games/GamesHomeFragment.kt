...
import id.mjs.etalaseapp.ui.home.apps.AppsHomeViewModel
...
class GamesHomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        carouselView = root.findViewById(R.id.carouselViewG) as CarouselView
    ...
    private fun setRecycleView(){
        ...
        rv_best_seller_gamesG.setHasFixedSize(true)
        rv_best_seller_gamesG.layoutManager = LinearLayoutManager(this.context, LinearLayoutManager.HORIZONTAL, false)
        rv_best_seller_gamesG.adapter = bestSellerGamesAdapter
    ...
    private fun showLoading(status : Boolean){
        ...
        val scrollView = view?.findViewById<ScrollView>(R.id.scroll_view_homeG)
        if (status){
